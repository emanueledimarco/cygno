...
- data experiment storage ([S3 based](https://it.wikipedia.org/wiki/Amazon_S3)) [status](https://monitoring.cloud.infn.it:3000/d/cygno-s3/storage-s3-cygno?orgId=1){:target="_blank" rel="noopener"}
